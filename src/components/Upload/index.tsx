...
const Upload = ({action, promise, progressHandler, to = "Products"}: {
    action: any,
    promise: any,
    progressHandler: any,
    to?: string
        ...
        <div className="flex justify-center items-center w-full h-full">
            ...
            <label htmlFor="file-upload"
                ...
                <div className="flex flex-col justify-center items-center pt-5 pb-6 gap-2">
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">Click here to upload</span>
                    </p>
