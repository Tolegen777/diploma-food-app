...
const Sidenav = ({
    ...
    return (
        <div
            className="flex md:flex-col w-full md:w-[20%] bg-gradient-to-br from-orange-400 to-orange-500 text-orange-50 px-3 py-4 justify-center items-center h-full">
            <SidenavHeader/>
            <SidenavMenu
...
const SidenavHeader = () => {
    ...
    return (
        ...
        >
            <Link
                onClick={() => ToggleAdminMode(dispatch, '')}
                to={"/"}
...
const SidenavFooter = () => {
    ...
    return (
        ...
        >
            ...
            <div className="" onClick={() => logout(user, dispatch, navigate)}>{t("columns.logout")}</div>
        </motion.div>
    );
};
